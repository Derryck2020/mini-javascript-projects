...
//console.log(btns) //This will give a NodeList, which we can only perform only forEach array method on it
...
btns.forEach(el => { 
    el.addEventListener('click', function(e){
        ...
        //let assign it to a variable styles which will save each time we click on our button
